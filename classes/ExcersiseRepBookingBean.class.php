...
class ExcersiseRepBookingBean extends DatabaseBean
{
    ...
    const NOSHOW = 0;
    /**> Booked, but did not show up. */
    const EXCUSED = 1;
    /**> Booked and excused themselves for not showing up. */
    const PASSED = 2;
    /**> Arrived and passed the test. */
    const FAILED = 3;
    /**> Arrived but did not pass the test. */

    const SESSION_LGRPID_KEY = 'lgrpid';

    /* Booking type to display */
    const BOOKING_ALL = 0;
    /**> All bookings for a student. */
    const BOOKING_NOSHOW = 1;
    /**> Only failed replacements (no show) */
    const BOOKING_FAILED = 2;
    /**> Only failed tests */
