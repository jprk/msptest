...
class LectureBean extends DatabaseBean
{
    ...
    function dbReplace()
    {
        ...
        DatabaseBean::dbQuery(
            ...
            . mysql_real_escape_string($this->syllabus) . "','"
            . mysql_real_escape_string($this->alert) . "','"
            . mysql_real_escape_string($this->thanks) . "','"
            . mysql_real_escape_string($this->locale) . "','"
            . mysql_real_escape_string(SchoolYearBean::termToEnum($this->term)) . "',"
            . $this->repl_students . ","
            . $this->repl_count . ","
            . $this->group_limit . ","
            . $this->group_type . ","
