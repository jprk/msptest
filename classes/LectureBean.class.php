...
class LectureBean extends DatabaseBean
{
    ...
    function dbReplace()
    {
        ...
        DatabaseBean::dbQuery(
            ...
            . $this->id . ",'"
            . $this->dbEscape($this->code) . "','"
            . $this->dbEscape($this->title) . "','"
            . $this->dbEscape($this->syllabus) . "','"
            . $this->dbEscape($this->alert) . "','"
            . $this->dbEscape($this->thanks) . "','"
            . $this->dbEscape($this->locale) . "','"
            . $this->dbEscape(SchoolYearBean::termToEnum($this->term)) . "',"
            . $this->repl_students . ","
            . $this->repl_count . ","
            . $this->group_limit . ","
            . $this->group_type . ","
