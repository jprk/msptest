...
function numToDayString ( $num )
{
	switch ( $num )
	{
		case  1: $name = "pondělí"; break;
		case  2: $name = "úterý";   break;
		case  3: $name = "středa";  break;
		case  4: $name = "čtvrtek"; break;
		case  5: $name = "pátek";   break;
		case  6: $name = "sobota";  break;
		case  7: $name = "neděle";  break;
		case 11: $name = "liché pondělí"; break;
		case 12: $name = "liché úterý";   break;
		case 13: $name = "lichá středa";  break;
		case 14: $name = "lichý čtvrtek"; break;
		case 15: $name = "lichý pátek";   break;
		case 16: $name = "lichá sobota";  break;
		case 17: $name = "lichá neděle";  break;
		case 21: $name = "sudé pondělí"; break;
		case 22: $name = "sudé úterý";   break;
		case 23: $name = "sudá středa";  break;
		case 24: $name = "sudý čtvrtek"; break;
		case 25: $name = "sudý pátek";   break;
		case 26: $name = "sudá sobota";  break;
		case 27: $name = "sudá neděle";  break;
		default: $name = "?????";
	}
