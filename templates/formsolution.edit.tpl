...
{section name=pId loop=$parts}
    ...
    <table cellspacing="1" cellpadding="0">
        <tr>
            <td>A =</td>
            <td><input type="text" id="fs_a{$parts[pId].part}" name="a[{$parts[pId].part}]" onblur="validnumber(this);">
            </td>
        </tr>
        <tr>
            <td>B =</td>
            <td><input type="text" id="fs_b{$parts[pId].part}" name="b[{$parts[pId].part}]" onblur="validnumber(this);">
            </td>
        </tr>
        <tr>
            <td>C =</td>
            <td><input type="text" id="fs_c{$parts[pId].part}" name="c[{$parts[pId].part}]" onblur="validnumber(this);">
            </td>
        </tr>
        <tr>
            <td>D =</td>
            <td><input type="text" id="fs_d{$parts[pId].part}" name="d[{$parts[pId].part}]" onblur="validnumber(this);">
            </td>
        </tr>
        <tr>
            <td>E =</td>
            <td><input type="text" id="fs_e{$parts[pId].part}" name="e[{$parts[pId].part}]" onblur="validnumber(this);">
            </td>
        </tr>
        <tr>
            <td>F =</td>
            <td><input type="text" id="fs_f{$parts[pId].part}" name="f[{$parts[pId].part}]" onblur="validnumber(this);">
            </td>
        </tr>
    </table>
{/section}
