...
{section name=pId loop=$parts}
    ...
    <table cellspacing="1" cellpadding="0">
        <tr>
            <td>A =</td>
            <td><input type="text" name="xa[{$parts[pId].part}]" value="{$aa[pId]}" disabled="disabled"></td>
        </tr>
        <tr>
            <td>B =</td>
            <td><input type="text" name="xb[{$parts[pId].part}]" value="{$bb[pId]}" disabled="disabled"></td>
        </tr>
        <tr>
            <td>C =</td>
            <td><input type="text" name="xc[{$parts[pId].part}]" value="{$cc[pId]}" disabled="disabled"></td>
        </tr>
        <tr>
            <td>D =</td>
            <td><input type="text" name="xd[{$parts[pId].part}]" value="{$dd[pId]}" disabled="disabled"></td>
        </tr>
        <tr>
            <td>E =</td>
            <td><input type="text" name="xe[{$parts[pId].part}]" value="{$ee[pId]}" disabled="disabled"></td>
        </tr>
        <tr>
            <td>F =</td>
            <td><input type="text" name="xf[{$parts[pId].part}]" value="{$ff[pId]}" disabled="disabled"></td>
        </tr>
    </table>
{/section}
<p>
