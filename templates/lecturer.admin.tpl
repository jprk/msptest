...
<table class="admintable" border="0" cellpadding="2" cellspacing="1">
    <tr class="newobject">
        ...
        <td width="40" class="smaller" valign="middle"
                ><a href="?act=edit,lecturer,0"><img src="images/add.gif" title="nový učitel" alt="[nový učitel]"
...
{section name=aId loop=$lecturerList}
    ...
    <td width="40" class="smaller" valign="middle"
            ><a href="?act=edit,lecturer,{$lecturerList[aId].id}"><img src="images/edit.gif" title="změnit" alt="[edit]"
                                                                       width="16" height="16"></a
            ><a href="?act=delete,lecturer,{$lecturerList[aId].id}"><img src="images/delete.gif" title="smazat"
