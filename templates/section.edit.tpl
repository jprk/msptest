...
function displayCorrespondingSelect ( obj )
{
	...
	if ( this.sval == "people" )
	{
      ...
      setDisplayMode ( "in_row_p1", HIDE );
      setDisplayMode ( "in_row_p2", HIDE );
    ...
    else if ( this.sval == "fylab" )
    {
      // Display lecture selection in element "in_row_s"
      // and hide selection in element "in_row_a"
      setDisplayMode ( "in_row_s1", HIDE );
      setDisplayMode ( "in_row_s2", HIDE );
      setDisplayMode ( "in_row_p1", SHOW );
      setDisplayMode ( "in_row_p2", SHOW );
      setDisplayMode ( "in_row_a1", HIDE );
      setDisplayMode ( "in_row_a2", HIDE );
      setDisplayMode ( "in_row_l1", HIDE );
      setDisplayMode ( "in_row_l2", HIDE );
      setIval1From ( document.sectionform.objid_p );
    }
    else
	{
...
{/literal}
<form name="sectionform" action="?act=save,section,{$section.id}" method="post">
...
<td class="itemtitle"
  ...
  ><span id="in_row_p1" style="display: block;">Číslo úlohy</span
...
<tr class="rowA">
<td colspan="2">
<textarea id="edcTextArea" name="text" style="width: 960px; height: 420px;">
