...
{if $studentList}
<p>
    Pokud hledáte mezi studenty se stejným jménen toho pravého, najeďte myší na příjmení či jméno &ndash; objeví se
...
<th class="smaller" style="width: 12em; border-bottom: 1px solid black;">Datum zápočtu</th>
</thead>
{* ---------- end header ---------- *}
