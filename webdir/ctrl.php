...
require ( REQUIRE_DIR . 'ExcersiseRepBookingBean.class.php');
require ( REQUIRE_DIR . 'ExcersiseReplacementBean.class.php');
...
switch ( $object )
{
	...
	case "evltsk":
		...
		break;
	case "excersise":
		$bean = new ExcersiseBean ( $id, $smarty, $action, $object );
		break;
	case "exclist":
		$bean = new ExcersiseListBean ( $id, $smarty, $action, $object );
		break;
    case "extension":
	...
	case "points":
		...
		break;
	case "repbooking":
		$bean = new ExcersiseRepBookingBean ( $id, $smarty, $action, $object );
		break;
	case "replacement":
		$bean = new ExcersiseReplacementBean ( $id, $smarty, $action, $object );
		break;
	case "schoolyear":
	...
	case "student":
		...
		break;
	case "stuexe":
		$bean = new StudentExcersiseBean ( $id, $smarty, $action, $object );
		break;
	case "stulec":
