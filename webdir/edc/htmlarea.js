...
HTMLArea.is_safari = ((HTMLArea.agt.indexOf("safari") != -1) && (!HTMLArea.is_chrome));
...
HTMLArea.prototype.outwardHtml = function(html)
{
  ...
  //  to expect
  // @CHANGE@ no, do not do this, it spoils our /static links ...
...
// The workaround for Chrome is probably also not quite correct.
HTMLArea.checkSupportedBrowser = function() {
  //dump(navigator).toString();
  //dump(HTMLArea).toString();
  if ( !HTMLArea.is_chrome && !HTMLArea.is_safari ) {
    if (HTMLArea.is_gecko) {
