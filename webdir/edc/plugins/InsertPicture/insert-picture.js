...
HTMLArea.prototype._insertImage = function(image)
{
  ...
  /* This is the URL of the image manager interface script.
     We have to supply two parameters to this script:
     (1) object id for which we want to display images,
     (2) image type.
     Both are stored as fields inside of `InsertPicture`. */
  var manager = _editor_url + 'plugins/InsertPicture/InsertPicture.php'
                + '?objid=' + InsertPicture.objid
                + '&ftype=' + InsertPicture.ftype;

  // alert ( 'Manager URL: "' + manager + '"' );
